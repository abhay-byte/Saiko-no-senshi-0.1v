...
public class M_skills : MonoBehaviour
{	
	public int val;
	...
	public GameObject EnableSkill1;
	public GameObject EnableSkill2;
	public GameObject EnableSkill3;
	public GameObject EnableSkill4;
	public GameObject EnableSkill5;

	public GameObject DisableSkill1;	
	public GameObject DisableSkill2;
	public GameObject DisableSkill3;
	public GameObject DisableSkill4;
	public GameObject DisableSkill5;
	...
	public void Skill1(){
		...
		EnableSkill1.SetActive(true);
		DisableSkill2.SetActive(false);
		DisableSkill3.SetActive(false);
		DisableSkill4.SetActive(false);
		DisableSkill5.SetActive(false);
	}

	public void Skill2(){
		
		EnableSkill2.SetActive(true);
		DisableSkill1.SetActive(false);
		DisableSkill3.SetActive(false);
		DisableSkill4.SetActive(false);
		DisableSkill5.SetActive(false);
	}
	...
	public void Skill5(){
		...
		EnableSkill5.SetActive(true);
		DisableSkill1.SetActive(false);
		DisableSkill2.SetActive(false);
		DisableSkill3.SetActive(false);
		DisableSkill4.SetActive(false);
	}
	public void M1(int ind){
		val = ind;
		
		if (ind == 1 ){
			A_1_1.SetActive(false);
			A_1_2.SetActive(false);
			A_1_3.SetActive(false);
			A_1_4.SetActive(false);
			A_1_5.SetActive(false);
			A_1_6.SetActive(true);
			A_1_7.SetActive(false);
			A_1_8.SetActive(false);
			A_1_9.SetActive(false);
			A_1_10.SetActive(false);
			
			A_2_6.SetActive(false);
			A_3_6.SetActive(false);
			A_4_6.SetActive(false);
			
			QuickSaveWriter.Create("Settings")
						   .Write(cryptography.Encrypt("A_1_1"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_2"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_3"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_4"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_6"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_1_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_10"), cryptography.Encrypt("false"))
						   
						   .Write(cryptography.Encrypt("A_2_6"), cryptography.Encrypt("false"))

						   .Write(cryptography.Encrypt("A_3_6"), cryptography.Encrypt("false"))

						   .Write(cryptography.Encrypt("A_4_6"), cryptography.Encrypt("false"))
		...
		if (ind == 2 ){
			A_2_1.SetActive(false);
			A_2_2.SetActive(false);
			A_2_3.SetActive(false);
			A_2_4.SetActive(false);
			A_2_5.SetActive(false);
			A_2_6.SetActive(true);
			A_2_7.SetActive(false);
			A_2_8.SetActive(false);
			A_2_9.SetActive(false);
			A_2_10.SetActive(false);
			
			A_1_6.SetActive(false);
			A_3_6.SetActive(false);
			A_4_6.SetActive(false);
			QuickSaveWriter.Create("Settings")
						   .Write(cryptography.Encrypt("A_1_6"), cryptography.Encrypt("false"))

						   .Write(cryptography.Encrypt("A_2_1"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_2"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_3"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_4"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_6"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_2_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_10"), cryptography.Encrypt("false"))
		...
		if (ind == 3 ){
			A_3_1.SetActive(false);
			A_3_2.SetActive(false);
			A_3_3.SetActive(false);
			A_3_4.SetActive(false);
			A_3_5.SetActive(false);
			A_3_6.SetActive(true);
			A_3_7.SetActive(false);
			A_3_8.SetActive(false);
			A_3_9.SetActive(false);
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_3_1"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_2"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_3"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_4"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_6"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_3_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_10"), cryptography.Encrypt("false"))
		...
		if (ind == 4 ){
			A_4_1.SetActive(false);
			A_4_2.SetActive(false);
			A_4_3.SetActive(false);
			A_4_4.SetActive(false);
			A_4_5.SetActive(false);
			A_4_6.SetActive(true);
			A_4_7.SetActive(false);
			A_4_8.SetActive(false);
			A_4_9.SetActive(false);
			A_4_10.SetActive(false);
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_4_1"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_2"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_3"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_4"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_6"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_4_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_10"), cryptography.Encrypt("false"))
	...
	public void M2(int ind){
		if (ind == 1 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_1_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_7"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_1_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_10"), cryptography.Encrypt("false"))
		...
		if (ind == 2 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_2_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_7"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_2_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_10"), cryptography.Encrypt("false"))
		...
		if (ind == 3 ){
			...
			A_3_5.SetActive(false);
			A_3_6.SetActive(false);
			A_3_7.SetActive(true);
			A_3_8.SetActive(false);
			A_3_9.SetActive(false);
			A_3_10.SetActive(false);
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_3_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_7"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_3_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_10"), cryptography.Encrypt("false"))
		...
		if (ind == 4 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_4_5"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_7"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_4_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_10"), cryptography.Encrypt("false"))
	...
	public void M3(int ind){
		if (ind == 1 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_1_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_8"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_1_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_10"), cryptography.Encrypt("false"))
		...
		if (ind == 2 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_2_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_8"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_2_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_10"), cryptography.Encrypt("false"))
		...
		if (ind == 3 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_3_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_8"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_3_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_10"), cryptography.Encrypt("false"))
		...
		if (ind == 4 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_4_6"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_8"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_4_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_10"), cryptography.Encrypt("false"))
	...
	public void M4(int ind){
		if (ind == 1 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_1_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_9"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_1_10"), cryptography.Encrypt("false"))
		...
		if (ind == 2 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_2_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_9"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_2_10"), cryptography.Encrypt("false"))
		...
		if (ind == 3 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_3_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_9"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_3_10"), cryptography.Encrypt("false"))
		...
		if (ind == 4 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_4_7"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_9"), cryptography.Encrypt("true"))
						   .Write(cryptography.Encrypt("A_4_10"), cryptography.Encrypt("false"))
	...
	public void M5(int ind){
		if (ind == 1 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_1_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_1_10"), cryptography.Encrypt("true"))
		...
		if (ind == 2 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_2_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_2_10"), cryptography.Encrypt("true"))
		...
		if (ind == 3 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_3_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_3_10"), cryptography.Encrypt("true"))
		...
		if (ind == 4 ){
			...
			QuickSaveWriter.Create("Settings")
						   ...
						   .Write(cryptography.Encrypt("A_4_8"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_9"), cryptography.Encrypt("false"))
						   .Write(cryptography.Encrypt("A_4_10"), cryptography.Encrypt("true"))
